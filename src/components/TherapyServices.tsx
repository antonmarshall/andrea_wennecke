...
const TherapyCard = ({ icon, title, description }: TherapyCardProps) => {
  return (
    <div className="bg-white p-6 rounded-lg shadow-md h-full transition-all duration-300 hover:shadow-lg hover:bg-gray-50">
